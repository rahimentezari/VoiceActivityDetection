...
opt = {
  ...
  saveIter = 1100,    -- write check point on this interval
  ...
  data_root = 'examples',
  data_list = '/home/deepface/Rahim/soundnet-VAD/movies/Train/Trainpathlabel.txt',
  test_list = '/home/deepface/Rahim/soundnet-VAD/movies/Train/Trainpathlabel.txt',
  save = '/home/deepface/Rahim/soundnet-VAD/logs_vad'
}
...
-- create data loader
local DataLoader = paths.dofile('data/data_edit.lua')
...
local fx = function(x)
  ...
  data_im,data_label = data:getBatch('train')
...
function Test()
  net:evaluate()
  confusion:zero()
  for i = 1, math.min(31842, opt.ntrain), opt.batchSize do -- for each mini-batch
    collectgarbage() -- necessary sometimes
    

    tm:reset()
    
    data_im,data_label = data:getBatch('test')
